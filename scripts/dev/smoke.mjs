...
const CHECKS = [
  ...
  { path: '/direitos-dados', status: 200 },
  { path: '/politica-cookies', status: 200 },
  { path: '/en/politica-privacidade', status: 200, includes: ['lang="en"'] },
  { path: '/admin', status: 200, includes: ['noindex'] },
  { path: '/en', status: 200, includes: ['lang="en"'] },
  { path: '/fr/voluntario', status: 200, includes: ['lang="fr"', 'hreflang="pt"', '/fr/voluntario"'] },
  { path: '/ar', status: 200, includes: ['lang="ar"', 'dir="rtl"'] },
  { path: '/robots.txt', status: 200, includes: ['Sitemap:', 'Disallow: /api/'] },
  { path: '/og/pt', status: 200, type: 'image/png' },
  { path: '/og/ja', status: 200, type: 'image/png' },
  { path: '/llms.txt', status: 200, type: 'text/plain', includes: ['# Projecto Caridade', '## Optional'] },
